...
|
| available -> free seat
| booked -> already taken by another student
| selected -> current student selected it
|
| Later:
| booked seats will come from Supabase database
|
*/
...
|   .from('seats')
|   .select('*')
|   .eq('shuttle_id', selectedShuttleId)
|
| If another student books a seat:
| status becomes "booked"
|
| The UI automatically changes the seat color
| because of getSeatClasses()
|
|--------------------------------------------------------------------------
*/
...
export default function SeatSelectionPage() {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Stores the seat selected by current student
  |
  */
  ...
  |
  | Later:
  | This can come from backend GPS tracking
  |
  */
  ...
  |
  | If seat is booked:
  | student cannot select it
  |
  | If another seat was selected before:
  ...
  */
  ...
  | booked seats automatically become gray
  |
  */
            ...
            <div className="max-w-[320px] mx-auto">
              ...
              <div className="flex justify-between items-center mb-12 pb-8 border-b border-dashed border-[var(--color-border)]">
                ...
                <div className="text-right">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-text-muted)] block mb-2">
                    Main Entry
                  </span>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[var(--color-primary-dark)] rounded-[2.5rem] p-8 text-white shadow-2xl shadow-blue-900/20">
            ...
            <div className="space-y-5 mb-8">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-bold bg-white/10 px-3 py-1 rounded-full uppercase tracking-widest text-green-300">
                  Free Pass
                </span>
          ...
          <div className="bg-[var(--color-bg-muted)] rounded-3xl p-6 border border-[var(--color-border)]">
            ...
            <div className="flex gap-4">
              ...
              <div className="p-3 bg-white rounded-xl shadow-sm">
                <Accessibility size={18} className="text-[var(--color-primary)]" />
              </div>
