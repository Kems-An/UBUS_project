...
import { ArrowLeft, Download, CheckCircle2, Bus, User, Phone, Calendar, Hash, MapPin } from 'lucide-react';
...
export default function TicketPage() {
  ...
  /*
    ...
    Contains all booking info + an integrity stamp.
    The driver scans this and verifies the bookingId in Supabase.
    If the bookingId doesn't exist in the database → fake ticket.
    If it exists and status = 'confirmed' → valid ticket.
  */
  ...
  /*
    ── SMART PRINT / DOWNLOAD ──
    Hides all page chrome, shows only the ticket card.
    Student saves as PDF from the print dialog.
  */
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-[var(--color-bg-muted,#f8fafc)]">
      <div className="w-full max-w-md space-y-4">
        ...
        {/*
          ...
          id="printable-ticket" is what the print CSS targets
        */}
        <div
          id="printable-ticket"
          ref={ticketRef}
        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-black">Your Shuttle Ticket</p>
                </div>
              </div>
          ...
          <div className="px-6 py-5 space-y-3">
            ...
            {ticket.routeName && (
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-[var(--color-text-muted)]">
                  <MapPin size={14} />
                  <span className="text-xs font-black uppercase tracking-wider">Route</span>
                </div>
                <span className="font-bold text-sm text-[var(--color-primary-dark)]">
                  {ticket.routeName}
                </span>
            ...
            <div className="pt-3 border-t border-[var(--color-border)]">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <span className="text-[10px] font-black text-[var(--color-primary-dark)] break-all max-w-[60%] text-right opacity-60">
                  {ticket.bookingId}
                </span>
              </div>
            </div>
          ...
          <div className="px-6 py-4 bg-[var(--color-bg-muted,#f8fafc)] border-t border-[var(--color-border)]">
            <p className="text-[10px] text-center text-[var(--color-text-muted)] font-medium">
              This ticket is valid for one trip only. Present QR code to the driver for boarding verification.
            </p>
          </div>
        </div>
