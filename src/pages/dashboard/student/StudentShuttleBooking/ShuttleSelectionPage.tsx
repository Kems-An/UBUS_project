...
export default function ShuttleSelectionPage() {
  ...
  |
  | Later:
  | 1. Admin creates shuttles
  | 2. Admin sets routes
  | 3. Admin marks shuttle as available
  | 4. Student dashboard fetches ONLY available shuttles
  |
  ...
  */
  ...
  |   .eq('status', 'available');
  |
  | Only shuttles marked as "available"
    ...
    <div className="pt-6 pb-12 px-8 lg:px-12 max-w-7xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        {availableShuttles.map((shuttle) => (
          ...
          <div
            key={shuttle.id}
            className="bg-white border border-[var(--color-border)] rounded-3xl p-6 hover:shadow-lg transition-all group"
          >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-6 w-full lg:w-auto">
                ...
                <div>
                  <h4 className="text-xl font-black text-[var(--color-primary-dark)]">
                    Departure: {shuttle.time}
                  </h4>
                  ...
                  <div className="flex items-center gap-4 mt-1">
                    ...
                    <span className="flex items-center gap-1.5 text-xs font-bold text-[var(--color-text-muted)]">
                      <Users size={14} />
                      {shuttle.cap} Seats Taken
                    </span>

                    <span
                      className={`text-[10px] font-black uppercase px-2 py-0.5 rounded-md ${
                        shuttle.speed === 'On Time'
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="p-2.5 bg-[var(--color-bg-muted)] rounded-xl text-[var(--color-primary)]">
                  <Wifi size={18} />
                </div>
